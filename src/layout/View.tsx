...
export function View() {
  ...
  return (
    <div className="absolute z-50 h-[50px] w-full lg:w-[calc(100%_-_304px)] flex lg:pl-[30px] font-montserrat font-bold text-sm bg-white border-b-[3px] border-[#eeeeee]">
      <div
